<template>
  ...
  <div class="text-center pt-2" v-if="users.length">
      <v-pagination
    ...
    methods: {
      ...
      deleteItemConfirm () {
        ...
        console.log(this.editedItem.id);
         axios
          .delete(process.env.VUE_APP_ROOT_API+"user/" + this.editedItem.id,{
            headers: { Authorization: "Bearer " + this.$jwt },
          })
          .then(() => {
      ...
      edit(id){
        ...
        console.log(index)
        axios
            .put(process.env.VUE_APP_ROOT_API+"user/" + id, this.editedItem,{
              headers: { Authorization: "Bearer " + this.$jwt },
            })
            .then(() => {
      ...
      add(){
        let item = this.editedItem;
        axios
            .post(process.env.VUE_APP_ROOT_API+"user", item, {
              headers: { Authorization: "Bearer " + this.$jwt },
            })
            .then(() => {
              this.getLastId();
